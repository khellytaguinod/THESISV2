			...
			<div class="logInBox">
				...
				<form>
				  ...
				  <div class="form-group">
				    ...
				    <button class="button" id="sign-in-button" name="submit" type="submit">Sign In!</button>
				    <br>
				  	<a href="forgotPassword.php">Forgot password?</a>
				  	<br>
				  	<small id="accountHelp" class="form-text text-muted text-center"> OR </small>
				  	<br>
				  	<button onclick="location.href='signUp.php'" type="button" id="register-button">Sign Up For iMarket</button>
				</form>
			</div>
		</div>
</div>
