		...
		<div class="row justify-content-md-center">
			...
			<div class="col-md-4 col-sm-10">
				...
				<small id="Help" class="form-text text-muted">
                   All fields required
               <medium style="color: red;">*</medium></small>
				<form>
					<div class="form-row">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<label><input id="studentType" type="radio" name="userType" value="student"
                                    onchange="studentChange()" required>Student</label>
							<i class="fa fa-graduation-cap" aria-hidden="true"></i>
							<label><input id="watch-you" type="radio" name="userType" value="employee"
                                    onchange="employeeChange()" required>Employee</label>
